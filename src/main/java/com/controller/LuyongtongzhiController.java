...
public class LuyongtongzhiController {
    ...
    public R save(@RequestBody LuyongtongzhiEntity luyongtongzhi, HttpServletRequest request){
    	luyongtongzhi.setId(new Date().getTime()+new Double(Math.floor(Math.random()*1000)).longValue());
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<LuyongtongzhiEntity> wrapper = new EntityWrapper<LuyongtongzhiEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = luyongtongzhiService.selectCount(wrapper);
