<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item v-if="type!='info'" class="date" label="提交时间" prop="tijiaoshijian">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.tijiaoshijian" class="input" label="提交时间" prop="tijiaoshijian">
      ...
      <el-col :span="24">  
        <el-form-item v-if="type!='info'&& !ro.zhengmingwenjian" class="upload" label="证明文件" prop="zhengmingwenjian">
          <file-upload
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.zhengmingwenjian" label="证明文件" prop="zhengmingwenjian">
            <el-button size="small" type="text" @click="download($base.url+ruleForm.zhengmingwenjian)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="12">
        <el-form-item v-if="type!='info'" class="input"  label="学校" prop="xuexiao">
          <el-input v-model="ruleForm.xuexiao" 
              :readonly="ro.xuexiao" clearable  placeholder="学校"></el-input>
        </el-form-item>
        <div v-else>
...
export default {
  ...
  methods: {
	...
	if(this.ruleForm.zhengmingwenjian!=null) {
		this.ruleForm.zhengmingwenjian = this.ruleForm.zhengmingwenjian.replace(new RegExp(this.$base.url,"g"),"");
	}
