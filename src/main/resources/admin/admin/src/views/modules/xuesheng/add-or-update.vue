<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item v-if="type!='info' && !ro.touxiang" class="upload" label="头像" prop="touxiang">
          <file-upload
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.touxiang" label="头像" prop="touxiang">
            <img v-for="(item,index) in ruleForm.touxiang.split(',')" v-bind:key="index" :src="$base.url+item" height="100" style="margin-right:20px;" width="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item v-if="type!='info'" class="select"  label="学历" prop="xueli">
          <el-select v-model="ruleForm.xueli" :disabled="ro.xueli" placeholder="请选择学历">
            <el-option
      ...
      <el-col :span="12">
        <el-form-item v-if="type!='info'" class="input"  label="年龄" prop="nianling">
          <el-input v-model="ruleForm.nianling" 
              :readonly="ro.nianling" clearable  placeholder="年龄"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        <el-form-item v-if="type!='info'" class="select"  label="研究生" prop="yanjiusheng">
          <el-select v-model="ruleForm.yanjiusheng" :disabled="ro.yanjiusheng" placeholder="请选择研究生">
            <el-option
                v-for="(item,index) in yanjiushengOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
      ...
      this.$http({
		...
		if(this.$storage.get("role")!="管理员") {
          ...
          this.$message.error(data.msg);
            ...
            this.xueliOptions = "大专,本科,硕士,博士,大专以下".split(',')
            this.yanjiushengOptions = "是,否".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
