<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item v-if="type!='info'" class="input"  label="参加人数" prop="canjiarenshu">
          <el-input v-model="ruleForm.canjiarenshu" 
              :readonly="ro.canjiarenshu" clearable  placeholder="参加人数"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        <el-form-item v-if="type!='info'" class="date" label="举办时间" prop="jubanshijian">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.jubanshijian" class="input" label="举办时间" prop="jubanshijian">
      ...
      <el-col :span="12">
        <el-form-item v-if="type!='info'" class="date" label="发布时间" prop="fabushijian">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.fabushijian" class="input" label="发布时间" prop="fabushijian">
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="讲会详情" prop="jianghuixiangqing">
                <editor 
                    v-model="ruleForm.jianghuixiangqing"
                    action="file/upload"
                    class="editor" 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.jianghuixiangqing" label="讲会详情" prop="jianghuixiangqing">
                    <span v-html="ruleForm.jianghuixiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.canjiarenshu = true;
          ...
          if(o=='jianghuixiangqing'){
            this.ruleForm.jianghuixiangqing = obj[o];
	    this.ro.jianghuixiangqing = true;
            continue;
          }
          if(o=='jubanshijian'){
	...
	this.ruleForm.jianghuixiangqing = this.ruleForm.jianghuixiangqing.replace(reg,'../../../springbootua77e/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
