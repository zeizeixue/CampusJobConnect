  ...
  <div class="main-content">
    ...
    <div v-if="showFlag">
      <el-form :inline="true" :model="searchForm" class="form-content">
        <el-row  :gutter="20" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}" class="slt">
                ...
                <el-form-item :label="contents.inputTitle == 1 ? '岗位' : ''">
                  <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 1" v-model="searchForm.gangwei" clearable placeholder="岗位" prefix-icon="el-icon-search"></el-input>
                  <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 2" v-model="searchForm.gangwei" clearable placeholder="岗位" suffix-icon="el-icon-search"></el-input>
                  <el-input v-if="contents.inputIcon == 0" v-model="searchForm.gangwei" clearable placeholder="岗位"></el-input>
                </el-form-item>
      ...
      <div class="table-content">
        <el-table v-if="isAuth('touzhixinxi','查看')" v-loading="dataListLoading" :border="contents.tableBorder"
		     ...
		     <template slot-scope="scope">
                  ...
                  <el-table-column :align="contents.tableAlign" :header-align="contents.tableAlign"  :sortable="contents.tableSortable"
                   label="简历"
                    prop="jianli">
                    <template slot-scope="scope">
                      <el-button size="small" type="text" @click="download($base.url+scope.row.jianli)">下载</el-button>
                    </template>
                  </el-table-column>
                <el-table-column  :align="contents.tableAlign" :header-align="contents.tableAlign"
                    :sortable="contents.tableSortable"
		    ...
		    prop="touzhishijian">
		     <template slot-scope="scope">
              ...
              <el-table-column v-if="isAuth('touzhixinxi','审核')" :align="contents.tableAlign"
                  :header-align="contents.tableAlign"
                  :sortable="contents.tableSortable"
                 label="审核"
                  prop="sfsh">
            ...
            <el-table-column :align="contents.tableAlign" :header-align="contents.tableAlign"
               label="操作"
                width="300">
                <template slot-scope="scope">
                <el-button v-if="isAuth('touzhixinxi','查看') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" icon="el-icon-tickets" size="mini" type="success" @click="addOrUpdateHandler(scope.row.id,'info')">{{ contents.tableBtnFont == 1?'详情':'' }}</el-button>
                <el-button v-if="isAuth('touzhixinxi','查看') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" size="mini" type="success" @click="addOrUpdateHandler(scope.row.id,'info')">{{ contents.tableBtnFont == 1?'详情':'' }}<i class="el-icon-tickets el-icon--right" /></el-button>
                <el-button v-if="isAuth('touzhixinxi','查看') && contents.tableBtnIcon == 0" size="mini" type="success" @click="addOrUpdateHandler(scope.row.id,'info')">{{ contents.tableBtnFont == 1?'详情':'' }}</el-button>
                <el-button v-if="isAuth('touzhixinxi','录用通知') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" icon="el-icon-tickets" size="mini" type="success" @click="luyongtongzhiCrossAddOrUpdateHandler(scope.row,'cross','是','[1]','已提交通知')">{{ contents.tableBtnFont == 1?'录用通知':'' }}</el-button>
                <el-button v-if="isAuth('touzhixinxi','录用通知') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" size="mini" type="success" @click="luyongtongzhiCrossAddOrUpdateHandler(scope.row,'cross','是','[1]','已提交通知')">{{ contents.tableBtnFont == 1?'录用通知':'' }}<i class="el-icon-tickets el-icon--right" /></el-button>
                <el-button v-if="isAuth('touzhixinxi','录用通知') && contents.tableBtnIcon == 0" size="mini" type="success" @click="luyongtongzhiCrossAddOrUpdateHandler(scope.row,'cross','是','[1]','已提交通知')">{{ contents.tableBtnFont == 1?'录用通知':'' }}</el-button>
                <el-button v-if=" isAuth('touzhixinxi','修改') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" icon="el-icon-edit" size="mini" type="primary" @click="addOrUpdateHandler(scope.row.id)">{{ contents.tableBtnFont == 1?'修改':'' }}</el-button>
                <el-button v-if=" isAuth('touzhixinxi','修改') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" size="mini" type="primary" @click="addOrUpdateHandler(scope.row.id)">{{ contents.tableBtnFont == 1?'修改':'' }}<i class="el-icon-edit el-icon--right" /></el-button>
                <el-button v-if=" isAuth('touzhixinxi','修改') && contents.tableBtnIcon == 0" size="mini" type="primary" @click="addOrUpdateHandler(scope.row.id)">{{ contents.tableBtnFont == 1?'修改':'' }}</el-button>




                <el-button v-if="isAuth('touzhixinxi','删除') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" icon="el-icon-delete" size="mini" type="danger" @click="deleteHandler(scope.row.id)">{{ contents.tableBtnFont == 1?'删除':'' }}</el-button>
                <el-button v-if="isAuth('touzhixinxi','删除') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" size="mini" type="danger" @click="deleteHandler(scope.row.id)">{{ contents.tableBtnFont == 1?'删除':'' }}<i class="el-icon-delete el-icon--right" /></el-button>
                <el-button v-if="isAuth('touzhixinxi','删除') && contents.tableBtnIcon == 0" size="mini" type="danger" @click="deleteHandler(scope.row.id)">{{ contents.tableBtnFont == 1?'删除':'' }}</el-button>
                </template>
            </el-table-column>
        </el-table>
        <el-pagination
    ...
    <luyongtongzhi-cross-add-or-update v-if="luyongtongzhiCrossAddOrUpdateFlag" ref="luyongtongzhiCrossaddOrUpdate" :parent="this"></luyongtongzhi-cross-add-or-update>
...
import luyongtongzhiCrossAddOrUpdate from "../luyongtongzhi/add-or-update";
export default {
  data() {
    return {
      searchForm: {
      ...
      luyongtongzhiCrossAddOrUpdateFlag: false,
  ...
  methods: {
    ...
    luyongtongzhiCrossAddOrUpdateHandler(row,type,crossOptAudit,statusColumnName,tips,statusColumnValue){
	if(crossOptAudit=='是'&&row.sfsh!='是') {
      ...
      this.luyongtongzhiCrossAddOrUpdateFlag = true;
      this.$storage.set('crossObj',row);
      this.$storage.set('crossTable','touzhixinxi');
		...
		for (var o in obj){
		  if(o==statusColumnName && obj[o]==statusColumnValue){
			...
			this.getDataList();
		      ...
		      this.showFlag = true;
		      this.luyongtongzhiCrossAddOrUpdateFlag = false;
			return;
		  }
		}
	}
      this.$nextTick(() => {
      this.$refs.luyongtongzhiCrossaddOrUpdate.init(row.id,type);
      });
    },
    chartDialog() {
    ...
    shDialog(row){
      ...
      if(row){
        this.shForm = {
          ...
          chufen: row.chufen,
          jianli: row.jianli,
          touzhishijian: row.touzhishijian,
