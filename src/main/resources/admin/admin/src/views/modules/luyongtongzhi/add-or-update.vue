<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item v-if="type!='info'" class="input"  label="企业账号" prop="qiyezhanghao">
          <el-input v-model="ruleForm.qiyezhanghao" 
              :readonly="ro.qiyezhanghao" clearable  placeholder="企业账号"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        <el-form-item v-if="type!='info'" class="input"  label="企业名称" prop="qiyemingcheng">
          <el-input v-model="ruleForm.qiyemingcheng" 
              :readonly="ro.qiyemingcheng" clearable  placeholder="企业名称"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        <el-form-item v-if="type!='info'" class="input"  label="企业规模" prop="qiyeguimo">
          <el-input v-model="ruleForm.qiyeguimo" 
              :readonly="ro.qiyeguimo" clearable  placeholder="企业规模"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        <el-form-item v-if="type!='info'" class="input"  label="负责人" prop="fuzeren">
          <el-input v-model="ruleForm.fuzeren" 
              :readonly="ro.fuzeren" clearable  placeholder="负责人"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        <el-form-item v-if="type!='info'" class="input"  label="联系号码" prop="lianxihaoma">
          <el-input v-model="ruleForm.lianxihaoma" 
              :readonly="ro.lianxihaoma" clearable  placeholder="联系号码"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        <el-form-item v-if="type!='info'" class="input"  label="企业地址" prop="qiyedizhi">
          <el-input v-model="ruleForm.qiyedizhi" 
              :readonly="ro.qiyedizhi" clearable  placeholder="企业地址"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        <el-form-item v-if="type!='info'" class="input"  label="企业邮箱" prop="qiyeyouxiang">
          <el-input v-model="ruleForm.qiyeyouxiang" 
              :readonly="ro.qiyeyouxiang" clearable  placeholder="企业邮箱"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        <el-form-item v-if="type!='info'" class="input"  label="岗位" prop="gangwei">
          <el-input v-model="ruleForm.gangwei" 
              :readonly="ro.gangwei" clearable  placeholder="岗位"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        <el-form-item v-if="type!='info'" class="input"  label="薪资待遇" prop="xinzidaiyu">
          <el-input v-model="ruleForm.xinzidaiyu" 
              :readonly="ro.xinzidaiyu" clearable  placeholder="薪资待遇"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        <el-form-item v-if="type!='info'" class="input"  label="学生账号" prop="xueshengzhanghao">
          <el-input v-model="ruleForm.xueshengzhanghao" 
              :readonly="ro.xueshengzhanghao" clearable  placeholder="学生账号"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        <el-form-item v-if="type!='info'" class="input"  label="学生姓名" prop="xueshengxingming">
          <el-input v-model="ruleForm.xueshengxingming" 
              :readonly="ro.xueshengxingming" clearable  placeholder="学生姓名"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        <el-form-item v-if="type!='info'" class="input"  label="手机号码" prop="shoujihaoma">
          <el-input v-model="ruleForm.shoujihaoma" 
              :readonly="ro.shoujihaoma" clearable  placeholder="手机号码"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        <el-form-item v-if="type!='info'" class="input"  label="学历" prop="xueli">
          <el-input v-model="ruleForm.xueli" 
              :readonly="ro.xueli" clearable  placeholder="学历"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        <el-form-item v-if="type!='info'" class="input"  label="专业" prop="zhuanye">
          <el-input v-model="ruleForm.zhuanye" 
              :readonly="ro.zhuanye" clearable  placeholder="专业"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        <el-form-item v-if="type!='info'" class="input"  label="研究生" prop="yanjiusheng">
          <el-input v-model="ruleForm.yanjiusheng" 
              :readonly="ro.yanjiusheng" clearable  placeholder="研究生"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        <el-form-item v-if="type!='info'" class="input"  label="处分" prop="chufen">
          <el-input v-model="ruleForm.chufen" 
              :readonly="ro.chufen" clearable  placeholder="处分"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        <el-form-item v-if="type!='info'" class="date" label="通知时间" prop="tongzhishijian">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.tongzhishijian" class="input" label="通知时间" prop="tongzhishijian">
      ...
      <el-col :span="12">
        <el-form-item v-if="type!='info'" class="select"  label="状态" prop="zhuangtai">
          <el-select v-model="ruleForm.zhuangtai" :disabled="ro.zhuangtai" placeholder="请选择状态">
            <el-option
