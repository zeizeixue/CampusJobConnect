      ...
      <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.picture" label="收藏图片" prop="picture">
            <img v-for="(item,index) in ruleForm.picture.split(',')" v-bind:key="index" :src="$base.url+item" height="100" style="margin-right:20px;" width="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item v-if="type!='info'" class="input"  label="推荐类型" prop="inteltype">
          <el-input v-model="ruleForm.inteltype" 
              :readonly="ro.inteltype" clearable  placeholder="推荐类型"></el-input>
        </el-form-item>
        <div v-else>
