      ...
      <el-col :span="12">
        <el-form-item v-if="type!='info'" class="input"  label="名称" prop="name">
          <el-input v-model="ruleForm.name" 
              clearable placeholder="名称" readonly></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.value" label="值" prop="value">
            <img v-for="(item,index) in ruleForm.value.split(',')" v-bind:key="index" :src="$base.url+item" height="100" style="margin-right:20px;" width="100">
          </el-form-item>
        </div>
      </el-col>
      </el-row>
