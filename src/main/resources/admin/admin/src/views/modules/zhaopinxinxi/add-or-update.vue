<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.fengmian" label="封面" prop="fengmian">
            <img v-for="(item,index) in ruleForm.fengmian.split(',')" v-bind:key="index" :src="$base.url+item" height="100" style="margin-right:20px;" width="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item v-if="type!='info'" class="select"  label="岗位" prop="gangwei">
          <el-select v-model="ruleForm.gangwei" :disabled="ro.gangwei" placeholder="请选择岗位">
            <el-option
      ...
      <el-col :span="12">
        <el-form-item v-if="type!='info'" class="input"  label="招聘人数" prop="zhaopinrenshu">
          <el-input v-model="ruleForm.zhaopinrenshu" 
              :readonly="ro.zhaopinrenshu" clearable  placeholder="招聘人数"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="企业详情" prop="qiyexiangqing">
                <editor 
                    v-model="ruleForm.qiyexiangqing"
                    action="file/upload"
                    class="editor" 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.qiyexiangqing" label="企业详情" prop="qiyexiangqing">
                    <span v-html="ruleForm.qiyexiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xinzidaiyu = true;
          ...
          if(o=='qiyexiangqing'){
            this.ruleForm.qiyexiangqing = obj[o];
	    this.ro.qiyexiangqing = true;
            continue;
          }
          if(o=='clicktime'){
	...
	this.ruleForm.qiyexiangqing = this.ruleForm.qiyexiangqing.replace(reg,'../../../springbootua77e/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
